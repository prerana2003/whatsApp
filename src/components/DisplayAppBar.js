    ...
    return(
                <Toolbar sx={{height:'66px',boxShadow:'none', backgroundColor:'#F0F2F5'}}>
                    <Grid item xs={1} sx={{display:{sm:'none'}}}>
                        <ArrowBackIcon onClick={()=>{navigate('/'); dispatch(setSelectedContact(""));}} sx={{fontSize:{xs:'large'}}}/>
                    </Grid>
                                ...
                                <Grid item marginTop='-8px' sx={{display:{xs:'none', sm:'block'}}}>
                                    <ListItemText
                                        secondary={
                                            <React.Fragment>
                                                {(alert) ?
                                                <Typography sx={{ fontFamily:font, display:{sm:'none', md:'block'}, fontSize:{sm:'9px', md:'14px'}, color:'#111B21'}} component="label">
